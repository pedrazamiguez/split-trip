...
class FeatureGateServiceImplTest {
    ...
    fun setUp() {
        ...
        service = FeatureGateServiceImpl(authenticationService)
    }
    ...
    @Test
    fun `checkLimit for MAX_MEMBERS_PER_GROUP when registered allows infinite members`() = runTest {
        // Given
        coEvery { authenticationService.isAnonymous() } returns false
        ...
        assertEquals(LimitResult.Allowed, service.checkLimit(GatedLimit.MAX_MEMBERS_PER_GROUP, 10).first())
    }
}
