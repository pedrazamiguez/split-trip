...
class AddOnCalculationServiceImpl(
     ...
     */
    override fun resolveAddOnAmountCents(
     ...
     */
    override fun calculateIncludedDiscountPercentageCents(
        sourceAmountCents: Long,
     ...
     */
    override fun calculateTotalOnTopAddOns(addOns: List<AddOn>): Long =
     ...
     */
    override fun calculateTotalAddOnExtras(addOns: List<AddOn>): Long =
     ...
     */
    override fun calculateEffectiveGroupAmount(baseGroupAmount: Long, addOns: List<AddOn>): Long {
     ...
     */
    override fun calculateIncludedBaseCost(
        totalAmountCents: Long,
        includedExactCents: Long,
        totalIncludedPercentage: BigDecimal,
        includedExactDiscountCents: Long,
        totalIncludedDiscountPercentage: BigDecimal
    ): Long {
     ...
     */
    override fun calculateEffectiveDeductedAmount(baseDeductedAmount: Long, addOns: List<AddOn>): Long {
     ...
     */
    override fun convertGroupToSourceCents(groupAmountCents: Long, exchangeRate: BigDecimal): Long {
     ...
     */
    override fun sumPercentagesFromInputs(amountInputs: List<String>): BigDecimal =
