...
class RegisterViewModelTest {
    ...
    inner class SubmitSignUp {
        ...
        fun `failure sets error in state`() = runTest(testDispatcher) {
            ...
            assertTrue(viewModel.uiState.value.error is UiText.StringResource)
            assertEquals(R.string.register_error_failed, (viewModel.uiState.value.error as UiText.StringResource).resId)
        }
    }
}
