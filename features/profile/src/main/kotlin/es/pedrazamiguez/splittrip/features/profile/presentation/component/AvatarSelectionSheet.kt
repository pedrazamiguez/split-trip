...
internal fun AvatarSelectionSheet(
    ...
    val actions = buildList {
        add(
            SheetAction(
                text = stringResource(R.string.avatar_sheet_camera),
        ...
        add(
            SheetAction(
                text = stringResource(R.string.avatar_sheet_gallery),
        ...
        if (showRemoveOption) {
            add(
                SheetAction(
                    text = stringResource(R.string.avatar_sheet_remove),
    ...
    ActionBottomSheet(
        title = stringResource(R.string.avatar_sheet_title),
        icon = TablerIcons.Outline.Camera,
        actions = actions,
        onDismiss = onDismiss
    )
